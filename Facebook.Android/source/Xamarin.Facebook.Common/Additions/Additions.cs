...
namespace Xamarin.Facebook.Share.Model
{
    ...
    public partial class ShareMessengerActionButton
    {
        public partial class Builder
        {
            ...
            {
                if (id_readFrom_Landroid_os_Parcel_ == IntPtr.Zero)
                    id_readFrom_Landroid_os_Parcel_ = JNIEnv.GetMethodID(class_ref, "readFrom", "(Landroid/os/Parcel;)Lcom/facebook/share/model/ShareMessengerActionButton$Builder;");
    ...
    public partial class ShareMessengerGenericTemplateElement
    {
        public partial class Builder
        {
            static IntPtr id_build;
            ...
            [Register("readFrom", "(Landroid/os/Parcel;)Lcom/facebook/share/model/ShareMessengerGenericTemplateElement$Builder;", "")]
            public global::Xamarin.Facebook.Share.Model.ShareMessengerGenericTemplateElement.Builder ReadFrom(global::Android.OS.Parcel p0)
            {
                if (id_readFrom_Landroid_os_Parcel_ == IntPtr.Zero)
                    id_readFrom_Landroid_os_Parcel_ = JNIEnv.GetMethodID(class_ref, "readFrom", "(Landroid/os/Parcel;)Lcom/facebook/share/model/ShareMessengerGenericTemplateElement$Builder;");
                global::Xamarin.Facebook.Share.Model.ShareMessengerGenericTemplateElement.Builder __ret = global::Java.Lang.Object.GetObject<global::Xamarin.Facebook.Share.Model.ShareMessengerGenericTemplateElement.Builder>(JNIEnv.CallObjectMethod(Handle, id_readFrom_Landroid_os_Parcel_, new JValue(p0)), JniHandleOwnership.TransferLocalRef);
                return __ret;
            }
        }
    }
